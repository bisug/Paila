          ...
          >
            ...
            <div className="flex items-center justify-between p-4 rounded-2xl bg-stone-50 border border-stone-200/60 mb-6">
              ...
              <button
                ...
                className={`relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-terracotta focus-visible:ring-offset-2 after:absolute after:-inset-3 after:content-[''] ${forceOffline ? "bg-amber-600" : "bg-stone-200"}`}
                role="switch"
              ...
              {cachedItems.map((item) => (
                ...
                >
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-[11px] text-stone-500 mt-0.5 truncate">{item.desc}</p>
                  </div>
                  <span className="text-[11px] font-bold text-stone-500 bg-stone-100 px-2 py-0.5 rounded-md shrink-0">
                    {item.size}
                  </span>
                </div>
              ))}
